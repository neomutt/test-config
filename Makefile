...
SRC	+= main.c
SRC	+= config/account.c config/address.c config/bool.c config/dump.c config/enum.c config/magic.c config/mbtable.c config/regex.c config/number.c config/path.c config/quad.c config/set.c config/sort.c config/string.c
SRC	+= test/common.c test/account.c test/address.c test/bool.c test/enum.c test/initial.c test/magic.c test/mbtable.c test/number.c test/path.c test/quad.c test/regex.c test/set.c test/sort.c test/string.c test/synonym.c
