...
SRC	+= mutt/buffer.c mutt/charset.c mutt/exit.c mutt/file.c mutt/hash.c mutt/logging.c mutt/mapping.c mutt/mbyte.c mutt/memory.c mutt/regex.c mutt/string.c
